...
export function ServiceCard({ service }: { service: Service }) {
  return (
    <Link
      ...
      className="group relative flex flex-col rounded-2xl border border-border bg-card p-7 transition-all duration-300 hover:-translate-y-1.5 hover:border-primary/40 hover:shadow-[var(--shadow-elevated)]"
    >
      ...
      <p className="mt-2 text-sm leading-relaxed text-text-muted">{service.short}</p>
